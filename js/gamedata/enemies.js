...
function GetEnemy(name) {
    switch(name) {
		...
		case "seaMan": return new EnemyDetail(GetDisplayName(name, 1), "lg", 2, { dx: -0.05, dy: 0.15, w: 1.1, h: 1.4 }, 10, 1, 1, 2, 2, true, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
