...
function GetEnemy(name) {
    switch(name) {
		...
		case "robber": return new EnemyDetail(GetDisplayName(name, 1), "md", 33, { dx: 0.25, dy: 0.15, w: -0.05, h: 0.6 }, 1000, 40, 35, 3, 1, true, [0, 0, 0, 1], "basic", "shotgun,timebomb", [ { money: true, min: 2500, max: 2500 } ], { tile: "roadtile" });
		...
		case "vendo": return new EnemyDetail(GetDisplayName(name, 1), "md", 31, { dx: 0.05, dy: -0.15, w: 0.4, h: 0.9 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 0], "basic", "burrito,dango,taco,kombucha,cheese,coffee", []);
		...
		case "beeQueenC": return new EnemyDetail(GetDisplayName(name, 1), "md", 34, { dx: 0, dy: 0, w: 0.45, h: 0.65 }, 10000, 5000, 200, 1, 1, false, [1, 0, 0, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "_beehive" });
	}
}
debug.AllEnemies = ["Discussly", "robo", "bigBot", "robo2", "robo3", "ScienceMan", "mouse", "sqorl", "bear", "turky", "bossturky", "Worker", "BossWorker", "kelpBoy", "fishFace", "seaMonk", "seaHandR", "seaMan", "seaHandL", "chickBot", "piggun", "golem", "lawnmower", "machineA", "machineB", "machineC", "machineD", "router", "server", "housekeeper", "outlet", "mrbruno", "mobsty1", "mobsty2", "mobBoss", "dweebLord", "robber", "brownCar", "blueCar", "redCar", "foodTruck", "delivTruck", "vendo", "hoverdweeb", "theMonster", "beeQueenA", "beeQueenB", "beeQueenC"];