...
function GetEnemy(name) {
    switch(name) {
		...
		case "botMush": return new EnemyDetail(GetDisplayName(name, 1), "md", 43, { dx: 0, dy: 0, w: 0.5, h: 0.75 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "batterysalt,gastank,food2kelp,food2coffee,food2salsa,food2gamer", [ { money: true, min: 0, max: 0 } ], { addtlHitCheck: "check_MUSH_w" });
		case "botRice": return new EnemyDetail(GetDisplayName(name, 1), "md", 44, { dx: 0, dy: 0, w: 0.5, h: 0.75 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "batterysalt,gastank,food2kelp,food2coffee,food2salsa,food2gamer", [ { money: true, min: 0, max: 0 } ], { addtlHitCheck: "check_RICE" });
		case "botFruit": return new EnemyDetail(GetDisplayName(name, 1), "md", 45, { dx: 0, dy: 0, w: 0.5, h: 0.75 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "batterysalt,gastank,food2kelp,food2coffee,food2salsa,food2gamer", [ { money: true, min: 0, max: 0 } ], { addtlHitCheck: "check_FRUIT" });
		case "botVeggie": return new EnemyDetail(GetDisplayName(name, 1), "md", 46, { dx: 0, dy: 0, w: 0.5, h: 0.75 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "batterysalt,gastank,food2kelp,food2coffee,food2salsa,food2gamer", [ { money: true, min: 0, max: 0 } ], { addtlHitCheck: "check_VEG" });
