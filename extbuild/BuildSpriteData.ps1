...
if($which.Contains("S")) {
    ...
    & "C:\Program Files\LibreOffice\program\scalc.exe" --headless --convert-to csv:"Text - txt - csv (StarCalc)":"44,34,0,,,,true" --outdir ".\temp" "Details_BigSprites.ods" | Out-Null;
    ...
    & "C:\Program Files\LibreOffice\program\scalc.exe" --headless --convert-to csv:"Text - txt - csv (StarCalc)":"44,34,0,,,,true" --outdir ".\temp" "Details_SmallSprites.ods" | Out-Null;
