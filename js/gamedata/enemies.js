...
function GetEnemy(name) {
    switch(name) {
		...
		/* Food2 HQ */
		case "trendyNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 34, { dx: 0.2, dy: 0.4, w: 0, h: 0.35 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "coffeeNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 35, { dx: 0.25, dy: 0.15, w: 0.05, h: 0.6 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "buffNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 36, { dx: 0.2, dy: 0.25, w: 0.05, h: 0.5 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "tinyNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 37, { dx: 0.35, dy: 0.55, w: -0.15, h: 0.2 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "theFunnyOne": return new EnemyDetail(GetDisplayName(name, 1), "md", 38, { dx: 0.05, dy: 0.35, w: 0.35, h: 0.4 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "robo4a": return new EnemyDetail(GetDisplayName(name, 1), "sm", 39, { dx: 0, dy: 0.4, w: 0, h: 0.1 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "robo4b": return new EnemyDetail(GetDisplayName(name, 1), "sm", 40, { dx: 0, dy: 0.25, w: 0, h: 0.25 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "robo4c": return new EnemyDetail(GetDisplayName(name, 1), "md", 41, { dx: 0, dy: -0.15, w: 0.5, h: 0.9 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "discuss2": return new EnemyDetail(GetDisplayName(name, 1), "sm", 42, { dx: 0, dy: 0.25, w: 0, h: 0.25 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "discuss2big": return new EnemyDetail(GetDisplayName(name, 1), "lg", 15, { dx: 0, dy: 0, w: 1, h: 1.5 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		...
		case "beckett": return new EnemyDetail(GetDisplayName(name, 1), "md", 47, { dx: 0.3, dy: 0.55, w: -0.1, h: 0.2 }, 10000, 400, 400, 4, 4, true, [0, 0, 0, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
