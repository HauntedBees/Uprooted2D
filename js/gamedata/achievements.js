var achievements = {
    ...
    "abee": { fromQuest: true },
    "techGood": { fromQuest: true }, // unimplemented
    "techBad": { fromQuest: true }, // unimplemented
    "natureGood": { fromQuest: true }, // unimplemented
    "natureBad": { fromQuest: true }, // unimplemented
    "vegan": { fromQuest: false }, // unimplemented
    "beeKing": { fromQuest: false }, // unimplemented
    "luddite": { fromQuest: false }, // unimplemented
    "springKing": { fromQuest: false }, // unimplemented
    "summerHummer": { fromQuest: false }, // unimplemented
    "autumnBottom": { fromQuest: false }, // unimplemented
    "winterHinter": { fromQuest: false }, // unimplemented
    "vegbuddy": { fromQuest: false }, // unimplemented
    "treebuddy": { fromQuest: false }, // unimplemented
    "mushbuddy": { fromQuest: false }, // unimplemented
    "eggbuddy": { fromQuest: false }, // unimplemented
    "ricebuddy": { fromQuest: false }, // unimplemented
    "beebuddy": { fromQuest: false }, // unimplemented
    "seabuddy": { fromQuest: false }, // unimplemented
