...
const game = {
    ...
    sheetsToLoad: [
                    ...
                    //* Profiles *//
                    "profiles/skump3", "profiles/skump2", "profiles/skump1", "profiles/vagante", "profiles/oldlady", "profiles/cooldog", "profiles/hkeep", "profiles/fjeff", "profiles/kelp", "profiles/cc", "profiles/smon", "profiles/conboss", "profiles/conwrk", "profiles/dowel", "profiles/cow", "profiles/robo", "profiles/beckettworry", "profiles/beckettshock", "profiles/beckettsad", "profiles/beckettmad", "profiles/fairymad", "profiles/fairy", "profiles/colel", "profiles/drjeff", "profiles/rapb", "profiles/lime", "profiles/fish", "profiles/rabbit", "profiles/tanner", "profiles/aiko", "profiles/june", "profiles/dean", "profiles/beckett", "profiles/conv", "profiles/nathupset", "profiles/nath", "profiles/nathconf", "profiles/nathmad",
                    //* Map Covers *//
