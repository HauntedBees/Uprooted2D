...
function GetEnemy(name) {
    switch(name) {
		...
		case "turky": return new EnemyDetail(GetDisplayName(name, 1), "md", 5, { dx: 0, dy: -0.1, w: 0.5, h: 0.85 }, 30, 4, 2, 2, 2, false, [0, 0, 1, 0], "slap", "", [ { money: true, min: 0, max: 5 }, { seed: "turkey", min: 0, max: 1 } ], { tile: "dirt" });
		case "bossturky": return new EnemyDetail(GetDisplayName(name, 1), "md", 5, { dx: 0, dy: -0.1, w: 0.5, h: 0.85 }, 60, 4, 2, 2, 2, true, [0, 0, 1, 0], "slap", "", [ { money: true, min: 50, max: 50 }, { seed: "turkey", min: 6, max: 6 } ], { tile: "dirt" });
		/* Bridge */
		case "Worker": return new EnemyDetail(GetDisplayName(name, 4), "md", 9, { dx: 0.25, dy: 0.5, w: 0, h: 0.25 }, 10, 1, 1, 2, 2, false, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ]);
		case "BossWorker": return new EnemyDetail(GetDisplayName(name, 1), "md", 12, { dx: 0.25, dy: 0.5, w: 0, h: 0.25 }, 10, 1, 1, 2, 2, true, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ]);
		/* Underwater */
		case "kelpBoy": return new EnemyDetail(GetDisplayName(name, 1), "md", 13, { dx: 0.15, dy: -0.15, w: 0.2, h: 0.9 }, 10, 1, 1, 2, 2, true, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
		case "fishFace": return new EnemyDetail(GetDisplayName(name, 1), "md", 10, { dx: 0.25, dy: 0.25, w: 0, h: 0.5 }, 10, 1, 1, 2, 2, false, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
		case "seaMonk": return new EnemyDetail(GetDisplayName(name, 1), "md", 11, { dx: 0, dy: -0.15, w: 0.5, h: 0.9 }, 10, 1, 1, 2, 2, false, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
		case "seaHandR": return new EnemyDetail(GetDisplayName(name, 1), "lg", 1, { dx: 0, dy: 0.15, w: 1, h: 1.35 }, 10, 1, 1, 2, 2, false, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
		case "seaMan": return new EnemyDetail(GetDisplayName(name, 1), "lg", 2, { dx: -0.05, dy: 0.15, w: 1.1, h: 1.4 }, 10, 1, 1, 2, 2, true, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile", soleKill: true });
		case "seaHandL": return new EnemyDetail(GetDisplayName(name, 1), "lg", 3, { dx: 0.05, dy: 1.85, w: 0.95, h: -0.2 }, 10, 1, 1, 2, 2, true, [1, 1, 1, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "watertile" });
		/* Fake Farm */
		...
		case "machineA": return new EnemyDetail(GetDisplayName(name, 1), "md", 14, { dx: 0.2, dy: 0.25, w: 0.1, h: 0.5 }, 10, 1, 1, 2, 2, true, [1, 1, 0, 0], "basic", "carrot", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { addtlHitCheck: "check_SP_SU" });
		case "machineB": return new EnemyDetail(GetDisplayName(name, 1), "md", 22, { dx: 0.2, dy: 0.25, w: 0.1, h: 0.5 }, 10, 1, 1, 2, 2, true, [1, 1, 0, 0], "basic", "carrot", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { addtlHitCheck: "check_AU_WI" });
		case "machineC": return new EnemyDetail(GetDisplayName(name, 1), "md", 23, { dx: 0.2, dy: 0.15, w: 0.1, h: 0.6 }, 10, 1, 1, 2, 2, true, [1, 1, 0, 0], "basic", "carrot", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { addtlHitCheck: "check_MUSH" });
		case "machineD": return new EnemyDetail(GetDisplayName(name, 1), "md", 24, { dx: 0.2, dy: 0.1, w: 0.1, h: 0.65 }, 10, 1, 1, 2, 2, true, [1, 1, 0, 0], "basic", "carrot", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { addtlHitCheck: "check_FISH" });
		...
		case "housekeeper": return new EnemyDetail(GetDisplayName(name, 1), "lg", 4, { dx: 0.55, dy: 0.85, w: -0.1, h: 0.3 }, 10, 1, 1, 2, 2, true, [1, 1, 0, 0], "basic", "carrot", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ]);
