...
function GetEnemy(name) {
    switch(name) {
		...
		/* North City */
		case "dweebLord": return new EnemyDetail(GetDisplayName(name, 1), "xl", 9, { dx: 0.5, dy: -0.65, w: 4.15, h: 3.75 }, 10000, 100, 100, 3, 2, true, [0, 0, 1, 0], "wacg", "", [ { money: true, min: 5000, max: 5000 }, { seed: "battery", min: 10, max: 10 }, { seed: "drone", min: 30, max: 30 }, { seed: "coffee", min: 20, max: 20 } ], { tile: "cybertile" });
		...
		/* Food2 HQ */
		case "trendyNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 34, { dx: 0, dy: 0, w: 0, h: 0 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "coffeeNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 35, { dx: 0, dy: 0, w: 0, h: 0 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "buffNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 36, { dx: 0, dy: 0, w: 0, h: 0 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "tinyNerd": return new EnemyDetail(GetDisplayName(name, 1), "md", 37, { dx: 0, dy: 0, w: 0, h: 0 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "theFunnyOne": return new EnemyDetail(GetDisplayName(name, 1), "md", 38, { dx: 0, dy: 0, w: 0, h: 0 }, 800, 30, 30, 3, 2, false, [1, 1, 1, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		...
		case "beckett": return new EnemyDetail(GetDisplayName(name, 1), "md", 39, { dx: 0, dy: 0, w: 0, h: 0 }, 10000, 400, 400, 4, 4, true, [0, 0, 0, 1], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		case "nathan": return new EnemyDetail(GetDisplayName(name, 1), "md", 40, { dx: 0, dy: 0, w: 0, h: 0 }, 10000, 400, 400, 4, 4, true, [0, 1, 0, 0], "basic", "egg", [ { money: true, min: 0, max: 0 } ]);
		/* Bee Queen */
		case "beeQueenA": return new EnemyDetail(GetDisplayName(name, 1), "md", 41, { dx: 0, dy: 0, w: 0.45, h: 0.65 }, 500, 50, 50, 1, 1, false, [1, 0, 0, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "_beehive" });
		case "beeQueenB": return new EnemyDetail(GetDisplayName(name, 1), "md", 41, { dx: 0, dy: 0, w: 0.45, h: 0.65 }, 2000, 500, 100, 1, 1, false, [1, 0, 0, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "_beehive" });
		case "beeQueenC": return new EnemyDetail(GetDisplayName(name, 1), "md", 41, { dx: 0, dy: 0, w: 0.45, h: 0.65 }, 10000, 5000, 200, 1, 1, false, [1, 0, 0, 0], "basic", "battery", [ { money: true, min: 0, max: 5 }, { seed: "carrot", min: 0, max: 1 } ], { tile: "_beehive" });
	}
}
debug.AllEnemies = ["Discussly", "robo", "bigBot", "robo2", "robo3", "ScienceMan", "mouse", "sqorl", "bear", "turky", "bossturky", "Worker", "BossWorker", "kelpBoy", "fishFace", "seaMonk", "seaHandR", "seaMan", "seaHandL", "chickBot", "piggun", "golem", "lawnmower", "machineA", "machineB", "machineC", "machineD", "router", "server", "housekeeper", "outlet", "mrbruno", "mobsty1", "mobsty2", "mobBoss", "dweebLord", "robber", "brownCar", "blueCar", "redCar", "foodTruck", "delivTruck", "vendo", "hoverdweeb", "trendyNerd", "coffeeNerd", "buffNerd", "tinyNerd", "theFunnyOne", "theMonster", "beckett", "nathan", "beeQueenA", "beeQueenB", "beeQueenC"];