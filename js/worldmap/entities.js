...
const mapentities = {
    ...
    "underwater": function() {
        let entities = [
            ...
            GetCSFellow("SeaMonsterCorpse", 18, 17, 0, "SeaMonCorpse", "seaCorpse", { big: true, visible: false, interact: OneSpeak("murderer") }),
    ...
    "southcity": () => [
        ...
        GetFellow("Capo", 35, 28, 0, "Capo", Cutscene("capo"), undefined, { moveToTalk: true }),
        // Boss
    ...
    "northcity_NG": () => [
        ...
        GetJumboToggle("OfficeL", 52, 42, true), GetJumboToggle("OfficeL", 52, 43, false),
        GetJumboToggle("OfficeR", 53, 42, true), GetJumboToggle("OfficeR", 53, 43, false),
        GetJumbo("13thStBuildings", "northcity2_post", 11, 14, 3072, 832, 0, 0),
        GetJumboToggle("Mushman", 15, 25, true), GetJumboToggle("Mushman", 15, 26, false),
        GetJumboToggle("BoringApt", 25, 25, true), GetJumboToggle("BoringApt", 25, 26, false),
        GetJumboToggle("FishApt", 35, 25, true), GetJumboToggle("FishApt", 35, 26, false),
        GetJumboToggle("NerndHaus", 44, 25, true), GetJumboToggle("NerndHaus", 44, 26, false),
        GetJumboToggle("XNerndHausL", 43, 25, true), GetJumboToggle("XNerndHausL", 43, 26, false),
        GetJumboToggle("XNerndHausL2", 42, 25, true), GetJumboToggle("XNerndHausL2", 42, 26, false),
        GetJumboToggle("XNerndHausR", 45, 25, true), GetJumboToggle("XNerndHausR", 45, 26, false),
        GetJumboToggle("SpinachApt", 53, 25, true), GetJumboToggle("SpinachApt", 53, 26, false),
        GetJumbo("14thStBuildings", "northcity1", 0, 0, 1276, 636, -1, -1),
        GetJumboToggle("BankL", 6, 8, true), GetJumboToggle("BankL", 6, 9, false),
        GetJumboToggle("BankR", 7, 8, true), GetJumboToggle("BankR", 7, 9, false),
        ...
        EnterShop("HotelL", 34, 43, "cityInn"),
        EnterShop("HotelR", 35, 43, "cityInn"),
        EnterShop("GordonsFarm", 43, 43, "gordonsFarming2"),
        EnterShop("CityExpandL", 24, 9, "cityExpansions"),
        EnterShop("CityExpandR", 25, 9, "cityExpansions"),
        EnterShop("CityTech", 55, 9, "cityTech"),
        GetFellow("crazy4trout", 34, 17, 2, "FishNernd", Cutscene("crazy4trout"), undefined, { visible: false, inside: true, moveToTalk: true }),
        ...
        // People
        GetFellow("SomeNerd", 15, 17, 3, "Nernd1", Cutscene("someNerd"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("SomeNewGuy", 28, 16, 0, "Carlos", Cutscene("newMoveIn"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("Painter", 33, 9, 0, "CoopPainter", OneSpeak("coopPainter"), undefined, { moveToTalk: true }),
        GetFellow("OfficeLady", 54, 35, 1, "GirlNernd", Cutscene("officeLady"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("CorpseBuddy", 55, 17, 0, "GamerCorpse", OneSpeak("corpseBuddy"), undefined, { visible: false, inside: true }),
        GetFellow("CityMonk", 36, 22, 2, "Monky", Cutscene("cityMonk"), undefined, { visible: false, inside: true }),
        // Misc. Entities
    ...
    "northcity_IG": () => [
        ...
        // People
        GetFellow("SomeNerd", 15, 17, 3, "Nernd1", Cutscene("someNerd"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("SomeNewGuy", 22, 21, 3, "Carlos", OneSpeak("newTechWorkerM"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("SomeNewGal", 26, 22, 1, "IGGirl1", OneSpeak("newTechWorkerW"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("NotCorpseLady", 52, 16, 0, "IGGirl2", OneSpeak("notCorpseLady"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("OfficeLady", 54, 35, 1, "GirlNernd", Cutscene("officeLady"), undefined, { visible: false, inside: true, moveToTalk: true }),
        GetFellow("CityMonk", 36, 22, 2, "Monky", Cutscene("cityMonk"), undefined, { visible: false, inside: true }),
        // Misc. Entities
        GetNoIMFellow("LavaLamp", 15, 20.25, "LavaLamp", { boring: true, inside: true, visible: false, moving: true }),
    ...
    "hq_IG": function() {
        const entities = [
            // Map Switches
            SwitchMap("Leave", 15, 30, false, false, 39, 10, "northcity_IG"),
            // Foreground
            GetForeground("hq_IG", 0, 1984),
            // Talky Entities
            GetCSFellow("Receptionist", 15.25, 23.375, 0, "Receptionist", "recep"),
            GetFellow("RecepionistTalkyL", 15, 24, 0, "", Cutscene("newRecep"), undefined, { boring: true, visible: false }),
            GetFellow("RecepionistTalkyR", 16, 24, 0, "", Cutscene("newRecep"), undefined, { boring: true, visible: false }),
            GetFellow("hungryboy", 14, 13, 0, "Hungy", OneSpeak("stillHungy"), undefined, { moving: true }),
            GetFellow("hungyBinU", 14, 11, 0, "", Cutscene("hungyBin"), undefined, { visible: false, boring: true }),
            GetFellow("hungyBinB", 14, 12, 0, "", Cutscene("hungyBin"), undefined, { visible: false, boring: true }),
            // Misc. Entities
            GetFellow("droppygarlic", 29, -1, 0, "Garlic", undefined, commonMovementDatas.fuckinBottle(29, -1, 3, 10), { solid: false, forcedY: 15 }),
            GetFellow("droppyapple", 29, -11, 0, "Apple", undefined, commonMovementDatas.fuckinBottle(29, -11, 3, 21), { solid: false, forcedY: 15 }),
            GetFellow("droppycorn", 29, -6, 0, "Corn", undefined, commonMovementDatas.fuckinBottle(29, -6, 3, 17), { solid: false, forcedY: 15 }),
            GetNoIMFellow("Chair1", 11, 25, "HQChairL", { boring: true }),
            GetNoIMFellow("Chair2", 11, 27, "HQChairL", { boring: true }),
            GetNoIMFellow("Chair3", 19, 25, "HQChairR", { boring: true }),
            GetNoIMFellow("Chair4", 19, 27, "HQChairR", { boring: true }),
