...
var mapentities = {
    ...
    "northcity": [
        ...
        GetCommonEntity("CompCover1", 50, 33, 22, 0, undefined, undefined, { sy: 7, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover2", 51, 33, 22, 1, undefined, undefined, { sy: 7, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover3", 50, 36, 22, 0, undefined, undefined, { sy: 8, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover4", 51, 36, 22, 1, undefined, undefined, { sy: 8, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover5", 50, 39, 22, 0, undefined, undefined, { sy: 8, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover6", 51, 39, 22, 1, undefined, undefined, { sy: 8, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover7", 55, 36, 22, 0, undefined, undefined, { sy: 7, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover8", 56, 36, 22, 1, undefined, undefined, { sy: 7, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover9", 55, 39, 22, 0, undefined, undefined, { sy: 8, solid: false, boring: true, visible: false, inside: true }),
        GetCommonEntity("CompCover0", 56, 39, 22, 0, undefined, undefined, { sy: 6, solid: false, boring: true, visible: false, inside: true }),
